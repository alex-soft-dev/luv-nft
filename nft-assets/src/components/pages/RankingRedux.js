      ...
      <section className='jumbotron breadcumb no-bg'>
        ...
        <div className='container'>
            ...
            <div className='col-12'>
                <h1 className='text-center'>All Assets</h1>
            </div>
            </div>
        </div>
        </div>
        ...
        <div className='row'>
          <div className='col-lg-12'>
            ...
            <div className='mainside'>
                <Link to="/create" className="btn-main">Create an asset</Link>
              </div>
            </div>
              ...
              <tbody>
                {
                  authors && authors.map((author, index) => (
                    <tr key={index}>
                      ...
                      <td>{author.attributes}</td>
                      <td>{author.collection}</td>
                      <td>{author.creators}</td>
